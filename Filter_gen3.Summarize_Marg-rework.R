...
lambda2 <- round(lambda,3)
   ...
   # #Zoom in on Chromosome 21 (Case-Only)
   # chr19 <- mdat.filtered2[mdat.filtered2$CHR==19,]
   # jpeg(paste0(output_path,"PM25_MAN_Chr19_",i,"_Filtered2.jpg"),width=800)
   # manhattan(chr19,main=paste0(i,", Chr19, ",nrow(mdat.filtered2)," SNPs, E = PM2.5"))
   # dev.off()
   # 
   # #Zoom in on chromosome 19 significant region (Case-Only)
   # jpeg(paste0(output_path,"PM25_MAN_Chr19_rs12980282_",i,"_Filtered2.jpg"),width=800)
   # manhattan(chr19,xlim=c(6.1,6.4),highlight=c("rs12980282"),main = "Chr19 rs12980282 Region")
   # dev.off()
