...
output_path <- "D:/PM25_Imputed_Results/Imputed/BMA/New/Result_Data/"
...
saveRDS(results,"D:/PM25_Imputed_Results/Imputed/BMA/New/combined_BMA_DF2.rds")
...
#Common SNP List
SNP.list <- readRDS(paste0(output_path,"common.snp.list.pm25.rds"))
SNP.list <- as.data.frame(SNP.list)
names(SNP.list) <- "SNP"
mdat.filtered2 <- merge(mdat.filtered2.i,SNP.list,by="SNP")
